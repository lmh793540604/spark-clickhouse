  ...
  def sql13(spark: SparkSession) = {
    spark.sql(
      """
        ...
        |	zhdq.JC_ID,
        |	zhdq.SZDW,
        |	to_unix_timestamp(case when b1.TCRQ<=to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') then to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') end) TCRQ,
        |	to_unix_timestamp(case when b1.TOUYUNRQ<=to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') then to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') end) TOUYUNRQ,
        |	to_unix_timestamp(case when b1.TUIYIRQ<=to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') then to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') end) TUIYIRQ,
        |	zhdq.XSDW_ID,
        |	to_unix_timestamp(case when b1.ZCRQ<=to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') then to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') end) ZCRQ,
        |	zhdq.ZCSX,
        |	b1.RERUN_FLAG,
        |	zhdq.ZCSX_ID,
        |	zhdq.DDDW_ID,
        ...
        |    ,e.empty ZSPL
        |    ,t1.ismerge ISMERGE
        |    ,to_unix_timestamp(case when jg.ZCRQ<=to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') then to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') end) JGZCRQ
        |    ,to_unix_timestamp(case when jg.TCRQ<=to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') then to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') end) JGTCRQ
        |    ,to_unix_timestamp(case when jg.TUIYIRQ<=to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') then to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') end) JGTUIYIRQ
        |    ,t1.TDSBDMF_ID
        |    ,t1.TDSBDMS_ID
        |    ,t1.TDSBDMT_ID
        |    ,t1.TDSBDM_ID
        ...
        |    ,to_unix_timestamp(case when zhdq.ZCRQ<=to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') then to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') end ) ZHDQZCRQ
        |    ,to_unix_timestamp(case when zhdq.TCRQ<=to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') then to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') end ) ZHDQTCRQ
        |    ,to_unix_timestamp(case when zhdq.TUIYIRQ<=to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') then to_date('1970-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss') end) ZHDQTUIYIRQ
        |FROM
        |	ZC_ZHDQ_JG_YJ b1
